...
**요청:** Day ${day}의 일정만 마크다운으로 출력해 주세요. 반드시 "## Day ${day} - ..."로 시작하고 아래 5개 섹션을 사용하세요.
- ### 아침 일정
- ### 점심 일정
- ### 저녁 일정
- ### 점심 식사 장소 추천
- ### 저녁 식사 장소 추천
- 일정 섹션(아침/점심/저녁 일정)에는 방문 동선 중심 장소를 넣어 주세요.
- 식사 장소 추천 섹션에는 실제 운영 중인 음식점 상호명을 1~2곳 넣어 주세요.
- 카페를 넣을 경우에도 반드시 실제 상호명만 사용하고, 가짜/임시 이름(예: 식당1, 카페1)은 금지합니다.
- 각 장소에는 **권장 체류 시간** 또는 **방문 팁**을 포함해 주세요.
- 각 장소 설명에는 해당 장소의 특징(대표 메뉴/분위기/포인트) 한 줄을 포함해 주세요.
      ...
      messages: [
        {
          role: "system",
          content:
            "여행 일정은 해당 Day 블록만 마크다운으로 출력합니다. 서두나 결론은 쓰지 않고 한국어로 작성합니다. 점심/저녁은 실제 음식점 상호명을 포함하고 가짜 장소명은 금지합니다.",
        },
